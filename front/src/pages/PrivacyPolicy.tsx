      ...
      <main className="flex-1 p-8 bg-gray-100">
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-700 mb-4">
            Bienvenue sur CareerMatch. Votre confidentialité est importante pour nous. Cette politique explique comment nous collectons, utilisons et protégeons vos données personnelles.
          </p>
          <h2 className="text-xl font-semibold text-gray-900 mt-6">1. Collecte des informations</h2>
          <p className="text-gray-700">
            Nous collectons des informations lorsque vous utilisez notre site, telles que votre nom, adresse e-mail et historique de navigation.
          </p>
          <h2 className="text-xl font-semibold text-gray-900 mt-6">2. Utilisation des informations</h2>
          <p className="text-gray-700">
            Les informations collectées sont utilisées pour améliorer nos services, vous fournir des recommandations et assurer la sécurité du site.
          </p>
        </div>
      </main>
